  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a0a0a]">
      ...
      <main className="flex-grow pt-10">
        <SubpageHero
          badge="OUR MISSION"
          title="Execution Authority for Autonomous Systems"
          subtitle="Caracal ensures that automated systems and AI agents can act only within explicitly delegated, time-bounded authority, and that every such action is provable before it happens."
        />
          ...
          <div className="container max-w-[1408px] mx-auto px-5 sm:px-12 desktop:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
              <div className="flex flex-col gap-8">
                <h2 className="text-white text-2xl sm:text-3xl font-mono uppercase font-bold leading-tight">The Boundary of Action</h2>
                <div className="flex flex-col gap-6 text-[#999999] text-base sm:text-lg leading-relaxed font-sans opacity-80">
                  <p>
                    Traditional identity systems rely on implicit trust. This model fails for dynamic AI agents that coordinate across systems and delegate work.
                  </p>
                  <p>
                    Caracal replaces implicit trust with explicit, cryptographically verifiable <span className="font-bold text-white">execution mandates</span> that define exactly what is allowed, by whom, and for how long.
                  </p>
                </div>
              </div>
